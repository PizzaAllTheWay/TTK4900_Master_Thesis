...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{Pictures/Results/Local_Map_Generation/Swath_Processing_Geometric_correction_zoomed_out.png}
    
    \vspace{0.5em}
    
    \includegraphics[width=0.95\linewidth]{Pictures/Results/Local_Map_Generation/Swath_Processing_Geometric_correction_zoomed_in.png}
